...
# Generated: Mon Aug 29 10:47:08 2016
##################################################
...
class electrosense_hopping_uhd(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, end_f=500e6, start_f=50e6):
        ...
        self.settings = Qt.QSettings("GNU Radio", "electrosense_hopping_uhd")
        ...
        self.electrosense_discard_samples_0 = electrosense.discard_samples(int(tune_delay * samp_rate), int(cfreq), pmt.intern("rx_time"), True)
...
def main(top_block_cls=electrosense_hopping_uhd, options=None):
    if options is None:
